...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-menu">
      ...
      <li class="active"><a href="employee-fitness-plans.php"><img src="../images/icons/dashboard-My_Plan-icon.svg" alt="Fitness Plans" class="nav-icon"> Fitness Plans</a></li>
    </ul>
  ...
  <div class="main-content">
    ...
    <!-- Available Trainers (like Duty Roster) -->
    <div class="card">
      <div class="employee-table-title">Available Trainers</div>
