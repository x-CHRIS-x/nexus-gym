...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['password'])) {
        ...
        $stmt->bind_param("ssssssssi", $firstName, $lastName, $email, $password, $phone, $membershipType, $join_date, $status, $id);
    } else {
        ...
        $stmt = $conn->prepare($query);
        $stmt->bind_param("sssssssi", $firstName, $lastName, $email, $phone, $membershipType, $join_date, $status, $id);
    }
